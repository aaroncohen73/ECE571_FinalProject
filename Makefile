...
all:
	vlog src/addsub.sv src/barrelshifter.sv src/findfirstone.sv src/floatingpoint.sv src/floatround.sv src/fpclass.sv src/fulladder.sv src/n2to1mux.sv src/rightshifter.sv src/floatingpointadder.sv src/tbfpadder.sv
